...
namespace PATHFIND
{
	...
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(float x, float y, float z, int nthClosest, Vector3* outPosition, float* heading, float* unknown1, int unknown2, float unknown3, float unknown4) { return invoke<BOOL>(0x80CA6A8B6C094CC4, x, y, z, nthClosest, outPosition, heading, unknown1, unknown2, unknown3, unknown4); } // 0x80CA6A8B6C094CC4 0x7349C856
	static int GET_NTH_CLOSEST_VEHICLE_NODE_ID_WITH_HEADING(float x, float y, float z, int nthClosest, Vector3* outPosition, float* outHeading, int nodeType, float p7, float p8) { return invoke<int>(0x6448050E9C2A7207, x, y, z, nthClosest, outPosition, outHeading, nodeType, p7, p8); } // 0x6448050E9C2A7207 0xC1AEB88D
	...
	static BOOL GET_VEHICLE_NODE_PROPERTIES(float p0, float p1, float p2, Any* p3, int* p4) { return invoke<BOOL>(0x0568566ACBB5DEDC, p0, p1, p2, p3, p4); } // 0x0568566ACBB5DEDC 0xCC90110B
	...
	static Any GET_CLOSEST_ROAD(float x, float y, float z, float p3, int p4, float* p5, float* p6, float* p7, float* p8, float* p9, BOOL p10) { return invoke<Any>(0x132F52BBA570FE92, x, y, z, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x132F52BBA570FE92 0x567B0E11
	...
	static int GENERATE_DIRECTIONS_TO_COORD(float x, float y, float z, BOOL p3, int* direction, Vehicle* vehicle, float* distToNxJunction) { return invoke<Any>(0xF90125F1F79ECDF8, x, y, z, p3, direction, vehicle, distToNxJunction); } // 0xF90125F1F79ECDF8 0xED35C094
